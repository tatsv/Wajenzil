	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Wajenzil</h2>
				<p>Construction Equipment Rental </p>
				<br><br>
				<center>
				...
				<div class="title mb-5 mt-5">
					...
					<div class="row">
							...
							<div class="card" style="width: 18rem;">
							  ...
							  <div class="card-body">
								  ...
								  <span class="card-text">Available: 3</span>
									<p class="card-text"> Rental fee: <span>Ksh.1500</span></p>
							...
							<div class="card" style="width: 18rem;">
							  ...
							  <div class="card-body">
								  ...
								  <span class="card-text">Available: 14</span>
									<p class="card-text"> Rental fee: <span>Ksh.600</span></p>
						...
						<div class="col-lg-4 mb-4">
							...
							<p class="card-text"> Rental fee: <span>Ksh.950</span></p>
					  ...
					  <div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<p class="card-text"> Rental fee: <span>Ksh.1000</span></p>
					  ...
					  <div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<p class="card-text"> Rental fee: <span>Ksh. 3000</span></p>
					  ...
					  <div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<p class="card-text"> Rental fee: <span>Ksh.2500</span></p>
					  ...
					  <div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<p class="card-text"> Rental fee: <span>Ksh.800</span></p>
					  ...
					  <div class="card" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<p class="card-text"> Rental fee: <span>Ksh.500</span></p>
...
<?php } else{?>  
	...
	<?php } ?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Wajenzil&copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Wajenzil<span></span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:wajenzil@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>
				<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Wajenzil</b></span>
				Wajenzil for purchase & rental
			</p>
